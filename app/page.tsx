...
export default function LandingPage() {
  ...
  return (
    <main className="relative min-h-screen">
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-2">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-linear-to-br from-amber-500 to-orange-600 shadow-md">
                <svg className="w-5 h-5 text-[var(--on-primary)]" viewBox="0 0 24 24" fill="currentColor">
      ...
      {/* Mobile Menu */}
      <div
        className={`mobile-menu-panel fixed inset-y-0 right-0 w-64 bg-[var(--surface)] z-50 p-6 md:hidden border-l border-[var(--border)] ${mobileMenuOpen ? "open" : ""}`}
      >
        <button
        ...
        <div className="flex flex-col gap-6 mt-12">
          <a href="#scholarships" className="text-[var(--muted)] hover:text-[var(--text)]" onClick={() => setMobileMenuOpen(false)}>Scholarships</a>
          <a href="#how-it-works" className="text-[var(--muted)] hover:text-[var(--text)]" onClick={() => setMobileMenuOpen(false)}>How It Works</a>
          <a href="#dashboard" className="text-[var(--muted)] hover:text-[var(--text)]" onClick={() => setMobileMenuOpen(false)}>Dashboard</a>
      ...
      <section className="relative min-h-screen flex items-center pt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-10">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
            <div className="reveal">
              ...
              <p className="text-base lg:text-lg text-[var(--muted)] mb-5 max-w-xl">
            ...
            <div className="reveal relative" style={{ transitionDelay: "0.2s" }}>
              <div className="dashboard-preview">
                <div className="dashboard-header">
                  ...
                  <span className="text-xs text-[var(--muted-2)] ml-2">My Applications</span>
                </div>
                      ...
                      <div key={item.name} className="flex items-center justify-between p-2.5 bg-[var(--surface-2)] rounded-lg border border-[var(--border)]">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-[var(--muted-2)]">{item.amount}</div>
                          </div>
                        </div>
        ...
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 scroll-indicator">
          <svg className="w-6 h-6 text-[var(--muted-2)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section id="scholarships" className="relative py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 reveal">
            ...
            <p className="text-[var(--muted)] max-w-2xl mx-auto">Browse through thousands of scholarships tailored to your background, interests, and goals.</p>
          </div>

          {/* Search Bar */}
          <div className="max-w-3xl mx-auto mb-8 reveal">
            <div className="search-box flex items-center gap-4">
              <svg className="w-5 h-5 text-[var(--muted-2)] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* How It Works */}
      <section id="how-it-works" className="relative py-20 section-tint-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 reveal">
            <h2 className="text-3xl md:text-4xl font-bold font-heading mb-4">Your Journey in 4 Simple Steps</h2>
            <p className="text-[var(--muted)] max-w-2xl mx-auto">We&apos;ve streamlined the scholarship application process so you can focus on what matters most.</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="reveal">
              ...
              <p className="text-[var(--muted)] mb-8">Track all your applications, deadlines, and awards in one intuitive dashboard. Never miss an opportunity again.</p>
            ...
            <div className="reveal dashboard-preview" style={{ transitionDelay: "0.2s" }}>
              <div className="dashboard-header">
                ...
                <div className="w-2.5 h-2.5 rounded-full bg-yellow-500" />
                <div className="w-2.5 h-2.5 rounded-full bg-green-500" />
                <span className="text-xs text-[var(--muted-2)] ml-2">Dashboard Overview</span>
              </div>
              <div className="p-6">
                <div className="grid grid-cols-3 gap-4 mb-6">
                  <div className="bg-[var(--surface-2)] rounded-xl p-4 text-center">
                    ...
                    <div className="text-xs text-[var(--muted-2)]">Applied</div>
                  </div>
                  <div className="bg-[var(--surface-2)] rounded-xl p-4 text-center">
                    <div className="text-2xl font-bold text-emerald-400 font-heading">3</div>
                    <div className="text-xs text-[var(--muted-2)]">Awarded</div>
                  </div>
                  <div className="bg-[var(--surface-2)] rounded-xl p-4 text-center">
                    <div className="text-2xl font-bold text-blue-400 font-heading">$22.5K</div>
                    <div className="text-xs text-[var(--muted-2)]">Total Won</div>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  <div className="text-sm font-medium text-[var(--text)]">Upcoming Deadlines</div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="reveal bg-linear-to-br from-amber-500/10 to-orange-500/5 border border-amber-500/20 rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-[var(--muted)] mb-8 max-w-2xl mx-auto">Your calm, structured workspace for scholarship applications. Create your free profile in under 5 minutes.</p>
              ...
              <p className="text-xs text-[var(--muted-2)] mt-6">No credit card required. Your data is secure and never shared.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="border-t border-[var(--border)] py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <div className="flex h-7 w-7 items-center justify-center rounded-md bg-linear-to-br from-amber-500 to-orange-600">
                  <svg className="w-3.5 h-3.5 text-[var(--on-primary)]" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z" />
                  </svg>
                </div>
                <span className="font-bold font-heading">ApplyPilot</span>
              </div>
              <p className="text-[var(--muted-2)] text-sm">A calm, structured workspace for scholarship applications. From discovery to submitted.</p>
            </div>
            <div>
              <h4 className="font-semibold mb-4 text-sm text-[var(--text)]">Platform</h4>
            ...
            <div>
              <h4 className="font-semibold mb-4 text-sm text-[var(--text)]">Company</h4>
              <ul className="space-y-2 text-sm text-[var(--muted-2)]">
          ...
          <div className="border-t border-[var(--border)] pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-[var(--muted-2)] text-sm">&copy; {new Date().getFullYear()} ApplyPilot. All rights reserved.</p>
            <div className="flex gap-4">
              <span className="text-[var(--muted-2)]" aria-label="Twitter">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" /></svg>
              </span>
              <span className="text-[var(--muted-2)]" aria-label="LinkedIn">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" /></svg>
              </span>
              <span className="text-[var(--muted-2)]" aria-label="Instagram">
